    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form action="/Todo/handlers/store-tasks.php" method="POST" class="form border p-2 my-5">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="handlers/delete_tasks.php?id=<?php echo $row['id']; ?>" class=" btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
